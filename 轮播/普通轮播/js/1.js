...
$(document).ready(function(){
     ...
     var number = slideBox.find(".spanBox p"); 
     ...
     number.on({
		mouseover:function(){
		$(this).addClass("active").siblings("p")
			 sw=$(this).index();
		ul.animate({
		...
		mouseout:function(){
		$(this).removeClass("active").siblings("p")	
		}
